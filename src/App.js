...
class App extends Component {
  ...
  favoriteThisOne = () => {
    ...
    const favoritePlayerData = this.state.activePlayers.find(
      (player) => player.PlayerID === favoritePlayerID
    )
  ...
  render() {
    return (
      <div className="app">
        ...
        <button className="make-favorite-button" onClick={this.favoriteThisOne}>
